    ...
    template: `
      <div class="bg-white">
            ...
            <div class="row">
              <div class="col-md-4 offset-md-4">
                <div class="schedule-indicators px-5 pt-3 pb-5">
                  <div class="background-line w-60"></div>
                  <div
          ...
          <div class="container py-5">
            ...
            <div class="accordion" id="faq">
              <div class="faq-card" v-for="(item, index) in pagesData.contactDetailsData.faq.items">
                <div class="faq-card-header cursor-pointer collapsed" :id="'heading-'+index" data-toggle="collapse" :data-target="'#collapse-' + index" aria-expanded="false" :aria-controls="'collapse-' + index">
        ...
        <div class="background-gray" v-if="currentModalItem === 2">
          <div class="container">
            <popular-cars viewPopularCars></popular-cars>
          </div>
        </div>
      </div>
    `
