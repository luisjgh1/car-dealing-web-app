...
description: 'Error 404 vehicle not found'
...
firstSection: {
  title: 'Looks like we have a navigational error'
}

content: {
  title: 'Error 404',
  subTitle: 'This page doesn''t exist or is no longer available',
  goBackButton: { text: 'Go back', url: '#!' },
  goHomeButton: { text: 'Go home', url: '#!' },
  otherPagesList: [
    { text: 'Shop by body style', url: '#!' },
    { text: 'All inventory', url: '#!' },
    { text: 'Get pre-approved', url: '#!' },
    { text: 'Service your car', url: '#!' },
    { text: 'Search all cars', url: '#!' },
    { text: 'Vehicles under $15k', url: '#!' },
    { text: 'Sell your car', url: '#!' },
    { text: 'Car loan calculator', url: '#!' },
  ]
}
